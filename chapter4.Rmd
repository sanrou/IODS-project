...
```{r hideLibraryOutput2, warning=FALSE, message=FALSE}
...
```{r biggerFigures4, fig.height=9, fig.width=9}
...
```{r biggerFigures42, fig.height=8, fig.width=8}
...
```{r biggerFigures3, fig.height=9, fig.width=9}
...
```{r hideWarning, warning=FALSE, message=FALSE}
